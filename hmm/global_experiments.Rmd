...
ggplot(ts_compare_df, aes(time, cumulative_reward, colour = model)) +
  geom_line(size = 1) +
  labs(title = "Cumulative Reward: Baseline vs AR(1) TS",
       y = "Cumulative Reward") +
  theme_minimal()

ggplot(ts_compare_df, aes(time, cumulative_regret, colour = model)) +
  geom_line(size = 1) +
  labs(title = "Cumulative Regret: Baseline vs AR(1) TS",
       y = "Cumulative Regret") +
  theme_minimal()
```
### 2.3.2 UCB AR
...
ggplot(ucb_compare_df, aes(time, cumulative_reward, colour = model)) +
  geom_line(size = 1) +
  labs(title = "Cumulative Reward: Baseline vs AR(1) UCB",
       y = "Cumulative Reward") +
  theme_minimal()

ggplot(ucb_compare_df, aes(time, cumulative_regret, colour = model)) +
  geom_line(size = 1) +
  labs(title = "Cumulative Regret: Baseline vs AR(1) UCB",
       y = "Cumulative Regret") +
  theme_minimal()
```
