...
```{r}
res_ts_ar <- thompson_ar(K, N, mu, y_local, z_local, batch_size = 100, burn = 500, n_iter = 100, dynamics = "independent")
```
...
```{r}
res_ar_ucb <- ucb_ar(K, N, mu, y_local, z_local, batch_size = 100, burn = 500, n_iter = 100, dynamics = "independent")
```
