...
generate_local_datasets(K = K, N = 5000, mu = theta, pi_list = pi_list, n_runs = 1, scenario_name = "single_run", root_path = "data_local")
```
...
```{r}
res_ar_ucb <- ucb_nimble_ar(K, N, theta, y_local, z_local, batch_size = 100, burn = 100, n_iter = 150, dynamics = "independent")
```
