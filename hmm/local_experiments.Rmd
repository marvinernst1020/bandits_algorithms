...
### Cumulative Reward:
```{r}
plotts<-plot_single_cumulative_regret(ts_compare_df)
...
plotucb<-plot_single_cumulative_regret(ts_ar_compare_df) 
...
### Cumulative Regret:
```{r}
plotucb<-plot_single_cumulative_regret(ucb_compare_df)
...
```{r}
plt<- plot_single_cumulative_regret(ucb_ar_compare_df)
