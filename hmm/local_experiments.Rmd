...
generate_local_datasets(K = K, N = N, theta = theta, pi_list = pi_list, n_runs = 1, scenario_name = "single_run", root_path = "data_local")
```
...
```{r}
generate_local_datasets(K = K, N = N, theta = theta, pi_list = pi_list, n_runs = 25, root_path = "data_local")
```
