...
In the section 17 and 19 we will be experimenting with Time-Varying Arm Rewards. This section deals with the case of Discrete Switching while section 19 deals with a Smoother Variation of Switching via Autoregressive processes (also mentioned in James Doulgas' book as Hamilton Markov‑Switching Autoregressive, MS-AR). While a Discrete Switching method is much simpler than Hamilton's MS-AR, it is still time varying.
...
```{r}
# 17. Time-Varying Within Arm-Rewards (Discrete Markov Switching) 
